CLASS zats_HA_data_builder DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZATS_HA_DATA_BUILDER IMPLEMENTATION.


  METHOD fill_master_data.
    data : lt_bp type table of zats_HA_bpa,
           lt_prod type table of zats_HA_product.
   ...
   append value #(
    ...
    append value #(
     ...
     insert zats_HA_bpa from table @lt_bp.
     insert zats_HA_product from table @lt_prod.
  ENDMETHOD.
  ...
  METHOD fill_transaction_data.
    data : o_rand type REF TO cl_abap_random_int,
           ...
           lv_ord_id type zats_HA_dte_id,
           lt_so type table of zats_HA_so_hdr,
           lt_so_i type table of zats_HA_so_item.
    ...
    select * from zats_HA_bpa into table @data(lt_bpa).
    select * from zats_HA_product into table @data(lt_prod).
    ...
    insert zats_HA_so_hdr from table @lt_so.
    insert zats_HA_so_item from table @lt_so_i.

  ENDMETHOD.


  METHOD flush.
    delete from : zats_HA_bpa, zats_HA_product, zats_HA_so_hdr, zats_HA_so_item.
  ENDMETHOD.
